...
#### 数据库管理系统（DBMS)的不同层级
<img src = "_includes/数据库_img/传输速度与大小的关系.png">

<img src = "_includes/数据库_img/数据库的不同层级.png">
...
<img src="_includes/数据库_img/splitting_leaf_node.jpg" style="zoom:25%;" >



<img src="_includes/数据库_img/splitting_a_inner_node.jpg">
...
<img src="_includes/数据库_img/Index_B+.jpg" style="zoom: 25%;" >

（搜索键，[uid,页面偏移量]）

[uid,页面偏移量] = 相应指针

<img src = "_includes/数据库_img/Alternative_2_Index.jpg" style="zoom:25%;" >



<img src = "_includes/数据库_img/Indx.jpg" style="zoom:25%;" >
...
<img src = "_includes/数据库_img/B+treecomplexity.jpg" style="zoom:50%;" >
...
<img src="_includes/数据库_img/LRU_replacement.jpg" style="zoom:25%;" >
