# Data base notes
![stars](https://unsplash.com/photos/a-blue-object-in-the-middle-of-a-black-sky-0Qgtp8VPnpI)
#### Data base
...
#### 数据库管理系统（DBMS)的不同层级
<img src = "images/数据库_img/传输速度与大小的关系.png">

<img src = "images/数据库_img/数据库的不同层级.png">
...
<img src="images/数据库_img/splitting_leaf_node.jpg" style="zoom:25%;" >



<img src="images/数据库_img/splitting_a_inner_node.jpg">
...
![cats](/Users/abigale.dong/Desktop/Abigale_dongzx/AbigaleD.github.io/images/cat.jpeg)

（搜索键，[uid,页面偏移量]）

[uid,页面偏移量] = 相应指针

<img src = "images/数据库_img/Alternative_2_Index.jpg" style="zoom:25%;" >



<img src = "images/数据库_img/Indx.jpg" style="zoom:25%;" >
...
<img src = "images/数据库_img/B+treecomplexity.jpg" style="zoom:50%;" >
...
<img src="images/数据库_img/LRU_replacement.jpg" style="zoom:25%;" >
